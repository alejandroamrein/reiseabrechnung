(function(app) {
  ...
  app.controller('homeController', ['loginService', 'PersonProject', '$state', homeController]);
  function homeController(loginService, PersonProject, $state) {
    var vm = this;
